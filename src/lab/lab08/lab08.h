...
namespace lab
{
    class Lab08 : public gfxc::SimpleScene
    {
     ...
     private:
        ...
        void RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 &modelMatrix, Texture2D *texture1 = NULL, Texture2D *texture2 = NULL, Texture2D *texture_snow = NULL, Texture2D *texture_water = NULL);
